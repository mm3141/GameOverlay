// <copyright file="KMean.cs" company="PlaceholderCompany">
...
namespace Radar
{
    ...
    /// <summary>
    /// A helper class for k-mean algorithm.
    /// </summary>
    public static class KMean
    {
        /// <summary>
        /// Perform k-mean algorithm on the data.
        /// </summary>
        /// <param name="rawData">grid points on which you want to perform the data.</param>
        /// <param name="numClusters">number of expected clusters.</param>
        /// <returns>clusters in the k-mean data.</returns>
